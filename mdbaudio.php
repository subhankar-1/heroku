...
<div class="container">
    <div class="row">
        <div class="col-sm-8">
		    ...
		    <form method='post' action="mdbinadb.php">
		    <div class="form-group">
                       <label for="audio url">Audio path</label>
                       <input type="text" class="form-control" id="url" placeholder="Enter audio path relative to apache server" name="url">
                     </div>
                     <div class="form-group">
