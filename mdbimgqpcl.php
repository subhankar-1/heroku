...
<? } else { ?>
<div class="container">
<form action="mdbresultimgcl.php" method="post">
...
#fetch and print image
	imagepng(imagecreatefromstring(base64_decode($doc['str64'])),"mdbvarimg".$i.".png"); echo ($i+1).")  " ; ?>
	<img src="mdbvarimg<?php echo $i ?>.png" height="200" weidth="200"/>
