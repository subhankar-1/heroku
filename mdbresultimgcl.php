	...
	if(isset($_POST['submit'])){
		if(!empty($_POST['quizcheck'])){
			...
			for($k=1;$k<=$count2;$k++){
				if($se[$k]=="")
				$count--;}
	?><div class="container text-center"  ><h1>Result of quiz</h1></div><br><br>
...
<br>
<br>
<br><div class="container text-center"  ><a href="mdbhome.php">logout and Go to homepage</a></div><br>
